...
class Simulator():
    ...
    Attributes:
        ...
        total_collisions (int): Counts the total number of collisions that occur during the simulation.
        total_fragment_collision (int): Counts the total number of collisions between fragments generated by a bigger collision.
