...
def _animate_merger(times:np.array, traj:list)->None:
    ...
    # Initial positions
    bh1 = create_black_hole(trajectory1[0],3)
    bh2 = create_black_hole(trajectory2[0],2)
    disk1 = create_accretion_disk(trajectory1[0],inner_radius=3.5, outer_radius=5.0)
    disk2 = create_accretion_disk(trajectory2[0], inner_radius=2.5, outer_radius=4.0)
...
class BinaryMerger():
    ...
    def animate(self):
        _animate_merger(self.time_vals, self.trajectory)
